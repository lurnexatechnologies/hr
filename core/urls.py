...
urlpatterns = [
    ...
    path('workflows/customize/', views.ManageWorkflowsView.as_view(), name='manage_workflows'),
    ...
    path('privacy-policy/', views.PoliciesView.as_view(), name='privacy_policy'),
    path('terms-of-service/', views.PoliciesView.as_view(), name='terms_of_service'),
